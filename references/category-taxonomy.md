---
title: "AI Daily News - Category Taxonomy"
---

# Category Taxonomy

This file defines the category system used by the AI Daily News skill.
...
- news items' category and tag fields
- JSON output
...
3. Use the same category labels in both category and tag fields.
...
## 6. Optional Secondary Tags (for data_tags field)

These tags can be used as secondary keywords in the `data_tags` field:
- 开源
- 多模态
- 推理
- 企业服务
...
These should be used only as secondary tags in `data_tags`, not as replacements for the six primary categories.

---

## 7. 核心关注领域到分类的映射

为确保搜索结果准确反映核心关注领域，以下是领域到分类的映射关系：

| 核心关注领域 | 对应分类 |
|------------|---------|
| AI 领域 | 模型与产品发布、Agent与应用落地、研究进展与技术趋势 |
| 音视频产品 | 模型与产品发布、Agent与应用落地 |
| 边缘计算 | 基础设施 / 芯片 / 算力 |
| 核心大厂动态 | 企业与商业化动态、模型与产品发布 |

### 映射规则：
1. **AI 领域**：
   - 大模型版本更新 → 模型与产品发布
   - AI Agent 形态 → Agent与应用落地
   - 多模态技术突破 → 研究进展与技术趋势
   - AI Native 应用创新 → Agent与应用落地
